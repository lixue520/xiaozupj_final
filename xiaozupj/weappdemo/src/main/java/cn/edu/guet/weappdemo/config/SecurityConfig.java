 ...
 * 4、加上Configuration注解，就会当做bean注册到Spring的IoC容器，以便可以注入
 */
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true)//全局方法的检测
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    /*
    重写2个方法
     */
    @Autowired
    @Qualifier("UserDetailsServiceImpl")//带名字声明
    ...
    //注册AuthenticationManager到IOC容器，下次可以直接注入使用
    @Bean

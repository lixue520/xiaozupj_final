package com.crush.security_code.auth.filter;

import com.crush.security_code.entity.MyUser;
import com.crush.security_code.service.IVerifyCodeService;
import com.crush.security_code.utils.JSON;
import com.crush.security_code.utils.JwtTokenUtils;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            MyUser loginUser = JSON.unmarshal(request.getInputStream(), MyUser.class);
            ...
            UsernamePasswordAuthenticationToken toke = new UsernamePasswordAuthenticationToken(

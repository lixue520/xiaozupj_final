...
import com.crush.excel.pojo.TemplateModel;
 ...
 * @author crush
 */
public class TemplateListener extends AnalysisEventListener<TemplateModel> {

    private static final Logger LOGGER = LoggerFactory.getLogger(TemplateListener.class);
     ...
     */
    @Override
    public void invoke(TemplateModel data, AnalysisContext context) {
        count++;

...
import com.crush.excel.pojo.ConditionModel;
 ...
 * @author crush
 */
public class ConditionListener extends AnalysisEventListener<ConditionModel> {
     ...
     */
    @Override
    public void invoke(ConditionModel data, AnalysisContext context) {
        count++;
